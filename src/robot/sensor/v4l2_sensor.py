...
class V4l2Sensor(BaseVisionSensor):
    ...
    def get_image(self):
        ...
        image["timestamp"] = time.monotonic()
...
if __name__ == "__main__":
    ...
    cam1.set_up("/dev/video0", is_jpeg=True)
    cam1.set_collect_info(["color"])

    cam2 = V4l2Sensor("test_v4l2_2")
    cam2.set_up("/dev/video2", is_jpeg=True)
    cam2.set_collect_info(["color"])

    cam3 = V4l2Sensor("test_v4l2_3")
    cam3.set_up("/dev/video4", is_jpeg=True)
    cam3.set_collect_info(["color"])
